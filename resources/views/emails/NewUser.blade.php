                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    style="padding:0;Margin:0;font-size:0"><a
                                                                        href="https://compras.fullgasnotificaciones.com.mx/" target="_blank"
                                                                        style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#FFFFFF;font-size:14px"><img
                                                                            src="{{asset('img/logo/FullGas_rojo2.png')}}"
                                                                            alt
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td esdev-links-color="#757575" align="center"
                                                                    ...
                                                                    <p
                                                                       ...
                                                                       PORFAVOR CLICK AL BOTÓN PARA REDIRIGIRTE AL SISTEMA.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <span class="es-button-border"
                                                                        style="border-style:solid;border-color:#26a4d3;background:none 0% 0% repeat scroll #26a4d3;border-width:0px;display:inline-block;border-radius:50px;width:auto"><a
                                                                            href="https://compras.fullgasnotificaciones.com.mx/"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <strong>En nombre de FULLGAS&copy;, le damos la más cordial bienvenida y expresamos nuestro agradecimiento por elegir ser parte de nuestra gran familia.

                                                                            Como miembro valioso, ahora tiene acceso a una amplia gama de funciones y recursos que junto a su valioso apoyo lograremos llegar a mejorar y alcanzar siempre nuestras metas.
                                                                            
                                                                        Creemos que su presencia contribuirá a nuestra vibrante comunidad y esperamos ser testigos de su éxito y crecimiento dentro de nuestra gran familia.</strong>
                                                                    </p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="esd-block-text es-p10t es-p10b" align="left">
                                                                    <p>A continuación le proporcionamos sus datos de acceso, favor de respetar mayúsculas y/o cualquier carácter que se defina a continuación para evitar problemas de acceso.</p>
                                                                    <small>Te recordamos que para apoyarte respecto al uso del sistema podrás apoyarte con los manuales que ponemos a tu disposición en el menú <strong>Sistema->Manuales</strong>.</small>
                                                                   <ul>
                                                                    <li>Usuario: {{$mailDataU['usuariousername']}}</li>
                                                                    <li>Contraseña: {{$mailDataU['pass']}}</li>
                                                                   </ul>
                                                                   <p>Para cualquier duda y/o aclaración no dude en contactarse con nosotros <i>sistemas@fullgas.com.mx</i> .</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="left"
                                                                    style="padding:0;Margin:0;font-size:0"><img
                                                                        src="{{asset('img/favicon/faviconnew.png')}}"
                                                                        alt
                                                                        style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                        width="40"></td>
                                                            </tr>
                                                                        ...
                                                                        <tr style="border-collapse:collapse">
                                                                            <td valign="top" align="center"
                                                                                ...
                                                                                <img title="Fullgas Bee"
                                                                                    src="{{asset('img/logo/AbejaFullGas2.png')}}"
                                                                                    alt="Fb" width="250" style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic">
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                        ...
                                                        <table width="100%" cellspacing="0" cellpadding="0"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        FullGas Energy Operator, Mérida, Yucatán, México.</p>
                                                                </td>
                                                            </tr>
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center"
                                                                ...
                                                                <td align="center"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        <a target="_blank"
                                                                            ...
                                                                            style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#666666;font-size:12px">Buen Trato</a>
                                                                        | <a target="_blank"
                                                                            href="https://www.fullgas.com.mx"
                                                            ...
                                                            <tr style="border-collapse:collapse">
                                                                <td align="center" style="padding:0;Margin:0">
                                                                    <p
                                                                        style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:18px;color:#666666;font-size:12px">
                                                                        Copyright © 2023 <strong>FULLGAS</strong>, Derechos Reservados.</p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
